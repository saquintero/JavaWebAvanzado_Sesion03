...
public class GestionProductos {
	...
	static {
		productosXcategorias.put(new Integer(1), 
					Arrays.asList(new Producto(10,"Smartphone","Detalle Smartphone","phone"),
								  new Producto(11,"Tablet","Detalle Tablet","tablet"),
								  new Producto(12,"Smartwach","Detalle Smartwach","smartwatch")));
